...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sperin Services — Premium Electrical & Building Services in the West Midlands" },
      ...
      { name: "twitter:title", content: "Sperin Services — Premium Electrical & Building Services in the West Midlands" },
