      ...
      faqs={[
        {
          ...
          a: "If yours is old (plastic or metal-clad without RCD protection), trips often, or you're adding new circuits like an EV charger, an upgrade is usually recommended.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes — full electrical certification is provided on completion.",
        },
        {
