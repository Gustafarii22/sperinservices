    ...
    <>
      ...
      {open && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Quick quote assistant"
        >
          <div className="surface-strong max-h-[88vh] w-full max-w-xl overflow-y-auto rounded-2xl border border-white/10 p-5 sm:p-7">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-bold">Tell us about the job.</h2>
              </div>
              <button
            ...
            {!service ? (
              ...
              <div className="mt-6">
                ...
                <p className="mt-4 text-xs text-muted-foreground">
                  This starts an enquiry, not a fixed quotation. Photos and a site visit can be
