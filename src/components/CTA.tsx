...
export function CTA({
  title = "Tell us what the job actually involves.",
  subtitle = "Send the postcode, a short description and any useful photos. We can then tell you the right next step instead of guessing from a generic form.",
}: {
  title?: string;
  subtitle?: string;
}) {
  return (
    <section className="mx-auto my-20 max-w-7xl px-4 lg:px-8">
      <div className="surface-raised relative overflow-hidden rounded-2xl p-7 sm:p-10 lg:p-12">
        ...
        <div className="relative max-w-3xl">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base">{subtitle}</p>
